...
// Same-origin Cloudflare Worker proxy (see src/worker/index.ts). The proxy
// constrains hosts to ultimate-guitar.com and rate-limits per IP. Public
// CORS proxies were removed for privacy/CSP reasons — if this route fails
// the user can paste the page source instead.
const PROXIES = [
